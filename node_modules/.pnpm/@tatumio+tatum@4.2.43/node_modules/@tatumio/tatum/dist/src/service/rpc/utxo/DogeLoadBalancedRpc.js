...
exports.DogeLoadBalancedRpc = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const typedi_1 = require("typedi");
const util_1 = require("../../../util");
// Need to import like this to keep browser working
const LoadBalancer_1 = require("../generic/LoadBalancer");
const AbstractDogeRpc_1 = require("./AbstractDogeRpc");
let DogeLoadBalancedRpc = class DogeLoadBalancedRpc extends AbstractDogeRpc_1.AbstractDogeRpc {
    constructor(id) {
        super();
...
exports.DogeLoadBalancedRpc = DogeLoadBalancedRpc;
exports.DogeLoadBalancedRpc = DogeLoadBalancedRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
//# sourceMappingURL=DogeLoadBalancedRpc.js.map
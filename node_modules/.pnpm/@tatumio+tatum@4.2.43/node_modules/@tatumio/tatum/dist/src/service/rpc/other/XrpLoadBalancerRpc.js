...
const AbstractXrpRpc_1 = require("./AbstractXrpRpc");
let XrpLoadBalancerRpc = class XrpLoadBalancerRpc extends AbstractXrpRpc_1.AbstractXrpRpc {
    constructor(id) {
        super();
...
exports.XrpLoadBalancerRpc = XrpLoadBalancerRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
//# sourceMappingURL=XrpLoadBalancerRpc.js.map
...
const AbstractBnbRpc_1 = require("./AbstractBnbRpc");
let BnbLoadBalancerRpc = class BnbLoadBalancerRpc extends AbstractBnbRpc_1.AbstractBnbRpc {
    constructor(id) {
        super();
...
exports.BnbLoadBalancerRpc = BnbLoadBalancerRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
//# sourceMappingURL=BnbLoadBalancerRpc.js.map
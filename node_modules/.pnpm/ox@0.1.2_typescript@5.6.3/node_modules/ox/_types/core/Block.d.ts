...
export type Block<includeTransactions extends boolean = false, blockTag extends Tag = 'latest', bigintType = bigint, numberType = number, transaction = Transaction.Transaction<blockTag extends 'pending' ? true : false, bigintType, numberType>> = Compute<{
    /** Base fee per gas */
    ...
    transactions: includeTransactions extends true ? readonly transaction[] : readonly Hex.Hex[];
    /** Root of this block’s transaction trie */
    transactionsRoot: Hex.Hex;
    /** List of uncle hashes */
    uncles: readonly Hex.Hex[];
    /** List of withdrawal objects */
    withdrawals?: readonly Withdrawal.Withdrawal<bigintType, numberType>[] | undefined;
...
export type Rpc<includeTransactions extends boolean = boolean, blockTag extends Tag = 'latest', transaction = Transaction.Rpc<blockTag extends 'pending' ? true : false>> = Block<includeTransactions, blockTag, Hex.Hex, Hex.Hex, transaction>;
/**
 ...
 */
export declare function toRpc<includeTransactions extends boolean = false, blockTag extends Tag = 'latest'>(block: Block<includeTransactions, blockTag>, _options?: toRpc.Options<includeTransactions, blockTag>): Rpc<boolean, blockTag>;
export declare namespace toRpc {
    var parseError: (error: unknown) => toRpc.ErrorType;
}
export declare namespace toRpc {
    type Options<includeTransactions extends boolean = false, blockTag extends Tag = 'latest'> = {
 ...
 */
export declare function fromRpc<const block extends Rpc | null, includeTransactions extends boolean = false, blockTag extends Tag = 'latest'>(block: block | Rpc | null, _options?: fromRpc.Options<includeTransactions, blockTag>): block extends Rpc ? Block<includeTransactions, blockTag> : null;

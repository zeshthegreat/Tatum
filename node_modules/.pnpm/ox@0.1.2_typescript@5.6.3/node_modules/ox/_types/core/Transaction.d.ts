 ...
 */
export type Transaction<pending extends boolean = false, bigintType = bigint, numberType = number> = UnionCompute<OneOf<Legacy<pending, bigintType, numberType> | Eip1559<pending, bigintType, numberType> | Eip2930<pending, bigintType, numberType> | Eip4844<pending, bigintType, numberType> | Eip7702<pending, bigintType, numberType> | (Base & {
    type: Hex.Hex;
})>>;
/**
 ...
 */
export type Rpc<pending extends boolean = false> = UnionCompute<OneOf<LegacyRpc<pending> | Eip1559Rpc<pending> | Eip2930Rpc<pending> | Eip4844Rpc<pending> | Eip7702Rpc<pending> | (BaseRpc & {
    type: Hex.Hex;
})>>;
...
export type Base<type extends string = string, pending extends boolean = false, bigintType = bigint, numberType = number> = Compute<{
...
export type BaseRpc<type extends string = string, pending extends boolean = false> = Base<type, pending, Hex.Hex, Hex.Hex>;
...
export type Eip1559<pending extends boolean = false, bigintType = bigint, numberType = number, type extends string = 'eip1559'> = Compute<Base<type, pending, bigintType, numberType> & {
...
export type Eip1559Rpc<pending extends boolean = false> = Compute<Eip1559<pending, Hex.Hex, Hex.Hex, ToRpcType['eip1559']>>;
...
export type Eip2930<pending extends boolean = false, bigintType = bigint, numberType = number, type extends string = 'eip2930'> = Compute<Base<type, pending, bigintType, numberType> & {
    /** EIP-2930 Access List. */
    accessList: AccessList.AccessList;
...
export type Eip2930Rpc<pending extends boolean = false> = Compute<Eip2930<pending, Hex.Hex, Hex.Hex, ToRpcType['eip2930']>>;
...
export type Eip4844<pending extends boolean = false, bigintType = bigint, numberType = number, type extends string = 'eip4844'> = Compute<Base<type, pending, bigintType, numberType> & {
    /** EIP-2930 Access List. */
    accessList: AccessList.AccessList;
...
export type Eip4844Rpc<pending extends boolean = false> = Compute<Eip4844<pending, Hex.Hex, Hex.Hex, ToRpcType['eip4844']>>;
...
export type Eip7702<pending extends boolean = false, bigintType = bigint, numberType = number, type extends string = 'eip7702'> = Compute<Base<type, pending, bigintType, numberType> & {
    /** EIP-2930 Access List. */
    accessList: AccessList.AccessList;
...
export type Eip7702Rpc<pending extends boolean = false> = Compute<Eip7702<pending, Hex.Hex, Hex.Hex, ToRpcType['eip7702']>>;
...
export type Legacy<pending extends boolean = false, bigintType = bigint, numberType = number, type extends string = 'legacy'> = Compute<Omit<Base<type, pending, bigintType, numberType>, 'chainId' | 'v' | 'yParity'> & {
...
export type LegacyRpc<pending extends boolean = false> = Compute<Legacy<pending, Hex.Hex, Hex.Hex, ToRpcType['legacy']>>;

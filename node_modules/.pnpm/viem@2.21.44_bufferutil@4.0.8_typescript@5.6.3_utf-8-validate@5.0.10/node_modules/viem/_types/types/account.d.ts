...
export type ParseAccount<accountOrAddress extends Account | Address | undefined = Account | Address | undefined> = accountOrAddress extends Address ? Prettify<JsonRpcAccount<accountOrAddress>> : accountOrAddress;

...
Object.defineProperty(exports, "getInjectiveIDAddress", {
  enumerable: true,
  get: function get() {
    return _address.getInjectiveIDAddress;
  }
});
...
var _sdkTs = require("@injectivelabs/sdk-ts");
var _utils = require("./utils");
var _address = require("./utils/address");
var _injective = require("./utils/injective");
var Resolver = /*#__PURE__*/function () {
  function Resolver(_ref) {
    var address = _ref.address,
      queryClient = _ref.queryClient,
      injectiveIdAddress = _ref.injectiveIdAddress;
...
var Name = /*#__PURE__*/function () {
  function Name(options) {
    ...
    var name = options.name,
      ...
      injectiveIdAddress = options.injectiveIdAddress,
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return (0, _injective.readContract)(this.queryClient, this.injectiveIdAddr, msg);
            case 4:
              res = _context.sent;
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              _context4.next = 9;
              return (0, _injective.readContract)(this.queryClient, resolverAddr, msg);
            case 9:
              res = _context4.sent;
...
var InjectiveID = /*#__PURE__*/function () {
  function InjectiveID(options) {
    (0, _classCallCheck2["default"])(this, InjectiveID);
    var grpc = options.grpc,
      chainId = options.chainId,
      injectiveIdAddress = options.injectiveIdAddress;
    if (!grpc) throw new Error('grpc is required');
    if (!chainId) throw new Error('chainId is required');
    this.queryClient = new _sdkTs.ChainGrpcWasmApi(grpc);
    this.chainId = chainId;
    this.injectiveIdAddr = injectiveIdAddress || (0, _address.getInjectiveIDAddress)(chainId);
  }
  (0, _createClass2["default"])(InjectiveID, [{
    key: "name",
      ...
      var _getName = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(address) {
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              reverseResolver = (0, _address.getInjectiveIDReverseResolverAddress)(this.chainId);
              if (reverseResolver) {
                _context5.next = 3;
                break;
              }
            ...
            case 3:
              ...
              _context5.next = 7;
              return (0, _injective.readContract)(this.queryClient, reverseResolver, msg);
            case 7:
              res = _context5.sent;

 ...
 *
 */
contract BNBRegistrarControllerV8 is Ownable {
    ...
    function register(
        ...
        registerWithConfigAndPoint(name, owner, duration, secret, address(0), address(0), false);
    }
    ...
    function registerWithConfig(
        ...
        registerWithConfigAndPoint(name, owner, duration, secret, resolver, addr, false);
    }
    ...
    function changePriceOracle(ISidPriceOracle _prices) public onlyOwner {
        prices = _prices;
        emit NewPriceOracle(address(prices));
    }

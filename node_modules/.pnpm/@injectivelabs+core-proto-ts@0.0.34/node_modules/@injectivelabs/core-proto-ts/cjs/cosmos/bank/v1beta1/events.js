...
exports.EventSetBalances = {
    ...
    fromJSON(object) {
        return {
            balanceUpdates: Array.isArray(object === null || object === void 0 ? void 0 : object.balanceUpdates)
                ? object.balanceUpdates.map((e) => exports.BalanceUpdate.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.balanceUpdates) {
            obj.balanceUpdates = message.balanceUpdates.map((e) => e ? exports.BalanceUpdate.toJSON(e) : undefined);
        }
        else {
            obj.balanceUpdates = [];
        }
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseEventSetBalances();
        message.balanceUpdates = ((_a = object.balanceUpdates) === null || _a === void 0 ? void 0 : _a.map((e) => exports.BalanceUpdate.fromPartial(e))) || [];
        return message;
    },
};

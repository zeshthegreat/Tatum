...
exports.State = exports.ABCIResponsesInfo = exports.ConsensusParamsInfo = exports.ABCIResponses = exports.protobufPackage = void 0;
/* eslint-disable */
const long_1 = __importDefault(require("long"));
const minimal_1 = __importDefault(require("protobufjs/minimal"));
const timestamp_1 = require("../../../google/protobuf/timestamp");
const types_1 = require("../../abci/v1beta2/types");
const types_2 = require("../../types/v1beta1/types");
const validator_1 = require("../../types/v1beta1/validator");
const params_1 = require("../../types/v1beta2/params");
const types_3 = require("../v1beta1/types");
exports.protobufPackage = "cometbft.state.v1beta2";
...
exports.State = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.version !== undefined) {
            types_3.Version.encode(message.version, writer.uint32(10).fork()).ldelim();
        }
        if (message.chainId !== "") {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.version = types_3.Version.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        return {
            version: isSet(object.version) ? types_3.Version.fromJSON(object.version) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        message.version !== undefined && (obj.version = message.version ? types_3.Version.toJSON(message.version) : undefined);
    ...
    fromPartial(object) {
        ...
        message.version = (object.version !== undefined && object.version !== null)
            ? types_3.Version.fromPartial(object.version)
            : undefined;

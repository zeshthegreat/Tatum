...
const events_1 = require("../../types/v1/events");
const types_1 = require("./types");
exports.protobufPackage = "cometbft.consensus.v1";
function createBaseMsgInfo() {
    return { msg: undefined, peerId: "", receiveTime: undefined };
}
exports.MsgInfo = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.receiveTime !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.receiveTime), writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.receiveTime = fromTimestamp(timestamp_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            ...
            receiveTime: isSet(object.receiveTime) ? fromJsonTimestamp(object.receiveTime) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.receiveTime !== undefined && (obj.receiveTime = message.receiveTime.toISOString());
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.receiveTime = (_b = object.receiveTime) !== null && _b !== void 0 ? _b : undefined;
        return message;
    },
};

...
exports.AssetPair = {
    ...
    fromJSON(object) {
        return {
            ...
            signedPrices: Array.isArray(object === null || object === void 0 ? void 0 : object.signedPrices)
                ? object.signedPrices.map((e) => exports.SignedPriceOfAssetPair.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.signedPrices) {
            obj.signedPrices = message.signedPrices.map((e) => e ? exports.SignedPriceOfAssetPair.toJSON(e) : undefined);
        }
        else {
            obj.signedPrices = [];
        }
    ...
    fromPartial(object) {
        ...
        message.signedPrices = ((_b = object.signedPrices) === null || _b === void 0 ? void 0 : _b.map((e) => exports.SignedPriceOfAssetPair.fromPartial(e))) || [];
        return message;
    },
};

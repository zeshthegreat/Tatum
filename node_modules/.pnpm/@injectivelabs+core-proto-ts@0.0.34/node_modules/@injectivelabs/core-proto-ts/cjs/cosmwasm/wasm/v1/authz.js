...
exports.StoreCodeAuthorization = {
    ...
    fromJSON(object) {
        return { grants: Array.isArray(object === null || object === void 0 ? void 0 : object.grants) ? object.grants.map((e) => exports.CodeGrant.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.grants) {
            obj.grants = message.grants.map((e) => e ? exports.CodeGrant.toJSON(e) : undefined);
        }
        else {
            obj.grants = [];
        }

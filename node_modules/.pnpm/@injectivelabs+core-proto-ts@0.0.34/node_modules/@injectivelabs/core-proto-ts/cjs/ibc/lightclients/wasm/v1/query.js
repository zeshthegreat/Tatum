...
exports.QueryChecksumsRequest = {
    ...
    create(base) {
        return exports.QueryChecksumsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryChecksumsRequest();
...
exports.QueryChecksumsResponse = {
    ...
    fromJSON(object) {
        return {
            checksums: Array.isArray(object === null || object === void 0 ? void 0 : object.checksums) ? object.checksums.map((e) => String(e)) : [],
    ...
    create(base) {
        return exports.QueryChecksumsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryChecksumsResponse();

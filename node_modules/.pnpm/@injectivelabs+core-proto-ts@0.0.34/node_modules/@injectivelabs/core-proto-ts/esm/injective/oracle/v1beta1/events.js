...
import { PythPriceState, StorkPriceState } from "./oracle";
...
export const EventSetStorkPrices = {
    ...
    fromJSON(object) {
        return { prices: Array.isArray(object === null || object === void 0 ? void 0 : object.prices) ? object.prices.map((e) => StorkPriceState.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.prices) {
    ...
    create(base) {
        return EventSetStorkPrices.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseEventSetStorkPrices();
        message.prices = ((_a = object.prices) === null || _a === void 0 ? void 0 : _a.map((e) => StorkPriceState.fromPartial(e))) || [];
        return message;
    },
};

...
export const GrantStorkPublisherPrivilegeProposal = {
    ...
    create(base) {
        return GrantStorkPublisherPrivilegeProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGrantStorkPublisherPrivilegeProposal();
        message.title = (_a = object.title) !== null && _a !== void 0 ? _a : "";
        message.description = (_b = object.description) !== null && _b !== void 0 ? _b : "";
        message.storkPublishers = ((_c = object.storkPublishers) === null || _c === void 0 ? void 0 : _c.map((e) => e)) || [];
        return message;
    },
};
...
export const RevokeStorkPublisherPrivilegeProposal = {
    ...
    create(base) {
        return RevokeStorkPublisherPrivilegeProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseRevokeStorkPublisherPrivilegeProposal();

...
import { BlockID, Part, PartSetHeader, Proposal as Proposal1, SignedMsgType, Vote as Vote2 } from "../../types/v1/types";
export declare const protobufPackage = "cometbft.consensus.v1";
/**
...
export interface HasProposalBlockPart {
    height: string;
    round: number;
    index: number;
}
...
export interface Message {
    ...
    hasProposalBlockPart?: HasProposalBlockPart | undefined;
}
...
export declare const HasProposalBlockPart: {
    encode(message: HasProposalBlockPart, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): HasProposalBlockPart;
    fromJSON(object: any): HasProposalBlockPart;
    toJSON(message: HasProposalBlockPart): unknown;
    create(base?: DeepPartial<HasProposalBlockPart>): HasProposalBlockPart;
    fromPartial(object: DeepPartial<HasProposalBlockPart>): HasProposalBlockPart;
};

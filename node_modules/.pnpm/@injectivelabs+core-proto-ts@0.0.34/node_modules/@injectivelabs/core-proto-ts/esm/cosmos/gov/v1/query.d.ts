...
export interface Query {
    ...
    Constitution(request: DeepPartial<QueryConstitutionRequest>, metadata?: grpc.Metadata): Promise<QueryConstitutionResponse>;
...
export declare const QueryConstitutionDesc: UnaryMethodDefinitionish;

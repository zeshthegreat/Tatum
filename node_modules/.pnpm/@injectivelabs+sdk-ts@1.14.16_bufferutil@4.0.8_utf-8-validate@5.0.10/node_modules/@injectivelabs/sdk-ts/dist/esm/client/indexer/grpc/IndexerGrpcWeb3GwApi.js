...
import { ErrorType, TransactionException, UnspecifiedErrorCode, } from '@injectivelabs/exceptions';
...
export class IndexerGrpcWeb3GwApi extends IndexerGrpcTransactionApi {
    ...
    async prepareEip712Request({ address, chainId, message, memo, sequence, accountNumber, estimateGas = true, gasLimit = DEFAULT_GAS_LIMIT, feeDenom = DEFAULT_BRIDGE_FEE_DENOM, feePrice = DEFAULT_BRIDGE_FEE_PRICE, timeoutHeight, eip712Version = 'v1', }) {

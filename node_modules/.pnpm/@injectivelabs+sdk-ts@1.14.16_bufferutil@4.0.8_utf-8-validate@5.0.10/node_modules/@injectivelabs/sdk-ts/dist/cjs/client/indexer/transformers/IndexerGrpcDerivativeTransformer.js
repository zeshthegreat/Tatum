...
class IndexerGrpcDerivativeTransformer {
    ...
    static binaryOptionsMarketResponseWithPaginationToBinaryOptionsMarket(response) {
        ...
        return {
            ...
            pagination: {
                ...
                total: parseInt((pagination === null || pagination === void 0 ? void 0 : pagination.total) || '0', 10),
                countBySubaccount: parseInt((pagination === null || pagination === void 0 ? void 0 : pagination.countBySubaccount) || '0', 10),
    ...
    static grpcTradeToTrade(trade) {
        ...
        const mappedPositionDelta = positionDelta
            ...
            : zeroPositionDelta();
        return Object.assign({ orderHash: trade.orderHash, tradeId: trade.tradeId, cid: trade.cid, subaccountId: trade.subaccountId, marketId: trade.marketId, executedAt: parseInt(trade.executedAt, 10), tradeExecutionType: trade.tradeExecutionType, executionSide: trade.executionSide, fee: trade.fee, feeRecipient: trade.feeRecipient, isLiquidation: trade.isLiquidation, payout: trade.payout }, mappedPositionDelta);
    }

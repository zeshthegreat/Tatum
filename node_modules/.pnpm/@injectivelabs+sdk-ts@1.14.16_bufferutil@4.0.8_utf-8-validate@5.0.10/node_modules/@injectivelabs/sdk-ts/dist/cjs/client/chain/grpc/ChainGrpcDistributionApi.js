...
class ChainGrpcDistributionApi extends BaseGrpcConsumer_1.default {
    ...
    fetchModuleParams() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.Params(request, this.metadata));
    ...
    fetchDelegatorRewardsForValidator(_a) {
        return __awaiter(this, arguments, void 0, function* ({ delegatorAddress, validatorAddress, }) {
            ...
            try {
                const response = yield this.retry(() => this.client.DelegationRewards(request, this.metadata));
    ...
    fetchDelegatorRewardsForValidatorNoThrow(_a) {
        return __awaiter(this, arguments, void 0, function* ({ delegatorAddress, validatorAddress, }) {
            const request = core_proto_ts_1.CosmosDistributionV1Beta1Query.QueryDelegationRewardsRequest.create();
            request.validatorAddress = validatorAddress;
            request.delegatorAddress = delegatorAddress;
    ...
    fetchDelegatorRewards(injectiveAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.DelegationTotalRewards(request, this.metadata));

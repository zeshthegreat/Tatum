...
class IndexerGrpcTransactionApi {
    ...
    prepareExchangeTxRequest(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.prepareTxRequest(Object.assign(Object.assign({}, args), { gasLimit: args.gasLimit || utils_1.DEFAULT_EXCHANGE_LIMIT }));
        });
    }
    prepareCosmosTxRequest(_a) {
        return __awaiter(this, arguments, void 0, function* ({ memo, address, message, estimateGas = true, gasLimit = utils_1.DEFAULT_GAS_LIMIT, feeDenom = utils_1.DEFAULT_BRIDGE_FEE_DENOM, feePrice = utils_1.DEFAULT_BRIDGE_FEE_PRICE, timeoutHeight, }) {
            const txFeeAmount = core_proto_ts_1.CosmosBaseV1Beta1Coin.Coin.create();
            txFeeAmount.denom = feeDenom;
            txFeeAmount.amount = feePrice;
            const cosmosTxFee = indexer_proto_ts_1.InjectiveExchangeRpc.CosmosTxFee.create();
     ...
     * in the block
     */
    broadcastTxRequest(_a) {
        return __awaiter(this, arguments, void 0, function* ({ signature, chainId, message, txResponse, }) {
     ...
     * in the block
     */
    broadcastCosmosTxRequest(_a) {
        return __awaiter(this, arguments, void 0, function* ({ address, signature, txRaw, pubKey, }) {

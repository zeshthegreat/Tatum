...
class MsgExecuteContract extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/cosmwasm.wasm.v1.MsgExecuteContract' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
        const message = Object.assign(Object.assign({}, (0, snakecase_keys_1.default)(proto)), { msg: this.getMsgObject() });
        return {
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/cosmwasm.wasm.v1.MsgExecuteContract' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {

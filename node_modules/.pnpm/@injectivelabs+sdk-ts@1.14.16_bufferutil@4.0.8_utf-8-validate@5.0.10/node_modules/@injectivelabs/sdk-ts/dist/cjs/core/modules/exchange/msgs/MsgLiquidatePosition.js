...
class MsgLiquidatePosition extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgLiquidatePosition' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgLiquidatePosition' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {

 ...
 * @category Messages
 */
class MsgAdminUpdateBinaryOptionsMarket extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgAdminUpdateBinaryOptionsMarket' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgAdminUpdateBinaryOptionsMarket' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
...
//# sourceMappingURL=MsgAdminUpdateBinaryOptionsMarket.js.map
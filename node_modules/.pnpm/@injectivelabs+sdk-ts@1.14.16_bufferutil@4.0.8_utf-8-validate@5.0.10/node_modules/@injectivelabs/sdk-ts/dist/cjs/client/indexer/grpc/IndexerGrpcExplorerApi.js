...
class IndexerGrpcExplorerApi extends BaseIndexerGrpcConsumer_1.default {
    ...
    fetchAccountTx(_a) {
        return __awaiter(this, arguments, void 0, function* ({ address, limit, type, before, after, startTime, endTime, }) {
    ...
    fetchPeggyDepositTxs(_a) {
        return __awaiter(this, arguments, void 0, function* ({ sender, receiver, limit, skip, }) {
    ...
    fetchBlocks(_a) {
        return __awaiter(this, arguments, void 0, function* ({ before, after, limit, from, to, }) {
    ...
    fetchTxs(_a) {
        return __awaiter(this, arguments, void 0, function* ({ before, after, limit, skip, type, chainModule, startTime, endTime, }) {
    ...
    fetchIBCTransferTxs(_a) {
        return __awaiter(this, arguments, void 0, function* ({ sender, receiver, srcChannel, srcPort, destChannel, destPort, limit, skip, }) {
    ...
    fetchExplorerStats() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.GetStats(request));
                return transformers_1.IndexerGrpcExplorerTransformer.getExplorerStatsResponseToExplorerStats(response);
            }
            catch (e) {
                if (e instanceof indexer_proto_ts_1.InjectiveExplorerRpc.GrpcWebError) {
                    throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {

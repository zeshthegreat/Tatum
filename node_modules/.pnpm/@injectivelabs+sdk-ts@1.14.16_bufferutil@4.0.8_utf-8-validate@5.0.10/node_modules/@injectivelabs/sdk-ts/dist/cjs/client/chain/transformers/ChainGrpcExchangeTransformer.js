...
const exchange_1 = require("@injectivelabs/core-proto-ts/cjs/injective/exchange/v1beta1/exchange");
/**
    ...
    static moduleParamsResponseToParams(response) {
        ...
        return {
            ...
            binaryOptionsMarketInstantListingFee: params.binaryOptionsMarketInstantListingFee
                ...
                : undefined,
            atomicMarketOrderAccessLevel: exchange_1.AtomicMarketOrderAccessLevel[params.atomicMarketOrderAccessLevel],

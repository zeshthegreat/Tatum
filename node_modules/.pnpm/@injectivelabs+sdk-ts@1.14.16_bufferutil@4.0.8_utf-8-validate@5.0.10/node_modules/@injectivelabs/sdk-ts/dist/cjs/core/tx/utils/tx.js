...
const createTxRawEIP712 = (txRaw, extension) => {
    ...
    const extensionAny = (0, helpers_1.createAny)(core_proto_ts_1.InjectiveTypesV1Beta1TxExt.ExtensionOptionsWeb3Tx.encode(extension).finish(), '/injective.types.v1beta1.ExtensionOptionsWeb3Tx');

...
class TxRestApi {
    ...
    fetchTx(txHash_1) {
        return __awaiter(this, arguments, void 0, function* (txHash, params = {}) {
            try {
    ...
    fetchTxPoll(txHash_1) {
        return __awaiter(this, arguments, void 0, function* (txHash, timeout = utils_1.DEFAULT_TX_BLOCK_INCLUSION_TIMEOUT_IN_MS || 60000) {
    ...
    broadcastTx(txRaw_1) {
        return __awaiter(this, arguments, void 0, function* (txRaw, mode = tx_rest_client_1.BroadcastMode.Sync) {
...
//# sourceMappingURL=TxRestApi.js.map
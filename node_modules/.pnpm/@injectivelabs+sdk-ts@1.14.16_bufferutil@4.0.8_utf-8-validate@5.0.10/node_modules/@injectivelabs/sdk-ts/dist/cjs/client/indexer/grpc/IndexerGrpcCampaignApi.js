...
class IndexerGrpcCampaignApi extends BaseIndexerGrpcConsumer_1.default {
    ...
    fetchCampaigns(_a) {
        return __awaiter(this, arguments, void 0, function* ({ type, active, limit, cursor, status, }) {
            ...
            try {
                const response = yield this.retry(() => this.client.CampaignsV2(request));
                return transformers_1.IndexerCampaignTransformer.CampaignsV2ResponseToCampaigns(response);
            }
            catch (e) {
                if (e instanceof indexer_proto_ts_1.InjectiveMetaRpc.GrpcWebError) {
                    throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {

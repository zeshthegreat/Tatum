 ...
 */
export declare function toBytes<point extends G1 | G2>(point: point): point extends G1 ? G1Bytes : G2Bytes;
 ...
 */
export declare function toHex<point extends G1 | G2>(point: point): point extends G1 ? G1Hex : G2Hex;
 ...
 */
export declare function fromBytes<group extends 'G1' | 'G2'>(bytes: Bytes.Bytes, group: group): group extends 'G1' ? G1 : G2;
 ...
 * @returns The BLS point.
 */
export declare function fromHex<group extends 'G1' | 'G2'>(hex: Hex.Hex, group: group): group extends 'G1' ? G1 : G2;
...
//# sourceMappingURL=BlsPoint.d.ts.map
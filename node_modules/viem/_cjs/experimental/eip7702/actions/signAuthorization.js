...
async function signAuthorization(client, parameters) {
    ...
    const delegate = (() => {
        if (typeof delegate_ === 'boolean')
            return delegate_;
        if (delegate_)
            return (0, parseAccount_js_1.parseAccount)(delegate_);
        return undefined;
    })();
    ...
    if (typeof authorization.nonce === 'undefined') {
        ...
        if (!delegate ||
            (delegate !== true && (0, isAddressEqual_js_1.isAddressEqual)(account.address, delegate.address)))

...
class IndexerRestExplorerApi extends BaseRestConsumer_1.default {
    ...
    fetchAccountTransactions(_a) {
        return __awaiter(this, arguments, void 0, function* ({ account, params, }) {
    ...
    fetchContractTransactions(_a) {
        return __awaiter(this, arguments, void 0, function* ({ contractAddress, params, }) {
    ...
    fetchContractTransactionsWithMessages(_a) {
        return __awaiter(this, arguments, void 0, function* ({ contractAddress, params, }) {
            const endpoint = `/contractTxs/${contractAddress}`;
            try {
                const { fromNumber, limit, skip, toNumber } = params || { limit: 12 };

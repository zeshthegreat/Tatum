...
class MsgBroadcasterWithPk {
    ...
    broadcast(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (json_1.ofacWallets.includes(privateKey.toHex())) {
    ...
    broadcastWithFeeDelegation(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (json_1.ofacWallets.includes(ethereumWallet)) {
                throw new exceptions_1.GeneralException(new Error('You cannot execute this transaction'));
            }
            const msgs = Array.isArray(transaction.msgs)
                ? transaction.msgs
                : [transaction.msgs];
            const tx = Object.assign(Object.assign({}, transaction), { msgs: msgs, ethereumAddress: ethereumWallet });
    ...
    simulate(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const accountDetails = yield new grpc_1.ChainGrpcAuthApi(endpoints.grpc).fetchAccount(publicKey.toAddress().toBech32());

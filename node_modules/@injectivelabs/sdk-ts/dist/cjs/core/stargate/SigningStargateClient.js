...
class SigningStargateClient extends StargateClient_1.StargateClient {
     ...
     */
    static createWithSigner(tmClient_1, signer_1) {
        return __awaiter(this, arguments, void 0, function* (tmClient, signer, options = {}) {
    ...
    sendTokens(senderAddress_1, recipientAddress_1, amount_1, fee_1) {
    ...
    delegateTokens(delegatorAddress_1, validatorAddress_1, amount_1, fee_1) {
    ...
    undelegateTokens(delegatorAddress_1, validatorAddress_1, amount_1, fee_1) {
        return __awaiter(this, arguments, void 0, function* (delegatorAddress, validatorAddress, amount, fee, memo = '') {
            const undelegateMsg = {
    ...
    withdrawRewards(delegatorAddress_1, validatorAddress_1, fee_1) {
    ...
    sendIbcTokens(senderAddress_1, recipientAddress_1, transferAmount_1, sourcePort_1, sourceChannel_1, timeoutHeight_1, timeoutTimestamp_1, fee_1) {
    ...
    signAndBroadcast(signerAddress_1, messages_1, fee_1) {
    ...
    signAmino(signerAddress_1, messages_1, fee_1, memo_1, _a) {
        return __awaiter(this, arguments, void 0, function* (signerAddress, messages, fee, memo, { accountNumber, sequence, chainId }) {
    ...
    signDirect(signerAddress_1, messages_1, fee_1, memo_1, _a) {
        return __awaiter(this, arguments, void 0, function* (signerAddress, messages, fee, memo, { accountNumber, sequence, chainId }) {
            (0, utils_1.assert)((0, proto_signing_1.isOfflineDirectSigner)(this.signer));
            const accountFromSigner = (yield this.signer.getAccounts()).find((account) => account.address === signerAddress);
            if (!accountFromSigner) {

...
class MsgCreateDenom extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.tokenfactory.v1beta1.MsgCreateDenom' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.tokenfactory.v1beta1.MsgCreateDenom' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {

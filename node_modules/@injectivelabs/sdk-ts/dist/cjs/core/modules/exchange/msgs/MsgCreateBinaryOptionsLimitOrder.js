 ...
 * @category Messages
 */
class MsgCreateBinaryOptionsLimitOrder extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateBinaryOptionsLimitOrder' }, proto);
    }
    toAmino() {
        const { params } = this;
        const order = createLimitOrder(params);
        const message = Object.assign({}, (0, snakecase_keys_1.default)(order));
        return {
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateBinaryOptionsLimitOrder' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
...
//# sourceMappingURL=MsgCreateBinaryOptionsLimitOrder.js.map
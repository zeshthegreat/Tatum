 ...
 * @category Messages
 */
class MsgCreateDerivativeMarketOrder extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateDerivativeMarketOrder' }, proto);
    }
    toAmino() {
        const { params } = this;
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateDerivativeMarketOrder' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
...
//# sourceMappingURL=MsgCreateDerivativeMarketOrder.js.map
...
const createSpotOrder = (args) => {
    ...
    const paramsFromArgs = Object.assign(Object.assign({}, args), { price: args.price, triggerPrice: args.triggerPrice || '0', quantity: args.quantity });
...
class MsgBatchUpdateOrders extends MsgBase_1.MsgBase {
    ...
    toProto() {
        ...
        if (params.spotOrdersToCreate && params.spotOrdersToCreate.length > 0) {
            const orderData = params.spotOrdersToCreate.map((args) => {
                ...
                return createSpotOrder(Object.assign(Object.assign(Object.assign({}, args), paramsFromArgs), { subaccountId: params.subaccountId }));
            });
        ...
        if (params.derivativeOrdersToCreate &&
            ...
            const orderData = params.derivativeOrdersToCreate.map((args) => {
                ...
                return createDerivativeOrder(Object.assign(Object.assign(Object.assign({}, args), paramsFromArgs), { subaccountId: params.subaccountId }));
            });
        ...
        if (params.binaryOptionsOrdersToCreate &&
            ...
            const orderData = params.binaryOptionsOrdersToCreate.map((args) => {
                const paramsFromArgs = Object.assign(Object.assign({}, args), { price: (0, numbers_1.amountToCosmosSdkDecAmount)(args.price).toFixed(), margin: (0, numbers_1.amountToCosmosSdkDecAmount)(args.margin).toFixed(), triggerPrice: (0, numbers_1.amountToCosmosSdkDecAmount)(args.triggerPrice || 0).toFixed(), quantity: (0, numbers_1.amountToCosmosSdkDecAmount)(args.quantity).toFixed() });
                return createBinaryOptionOrder(Object.assign(Object.assign(Object.assign({}, args), paramsFromArgs), { subaccountId: params.subaccountId }));
            });
            message.derivativeOrdersToCreate = orderData;
        }
    ...
    toAmino() {
        ...
        if (params.derivativeOrdersToCreate &&
            params.derivativeOrdersToCreate.length > 0) {
            const orderData = params.derivativeOrdersToCreate.map((args) => {
                const paramsFromArgs = Object.assign(Object.assign({}, args), { price: args.price, margin: args.margin, triggerPrice: args.triggerPrice || '0', quantity: args.quantity });
                return createDerivativeOrder(Object.assign(Object.assign(Object.assign({}, args), paramsFromArgs), { subaccountId: params.subaccountId }));
            });
            message.derivativeOrdersToCreate = orderData;
        }
        ...
        const msg = Object.assign({}, (0, snakecase_keys_1.default)(core_proto_ts_1.InjectiveExchangeV1Beta1Tx.MsgBatchUpdateOrders.fromPartial(message)));
        return {

 ...
 */
export const numberTypeToReflectionNumberType = (property) => {
    switch (property) {
        case 'order_mask':
            return 'int32';
 ...
 */
export const mapValuesToProperValueType = (object, messageTypeUrl) => {
            ...
            if (Array.isArray(value)) {
                return {
                    ...
                    [key]: value.every((i) => typeof i === 'string')
                        ? value
                        : value.map((item) => mapValuesToProperValueType(item)),
                };
            }
            return {
                ...result,
                [key]: mapValuesToProperValueType(value),
            };
        }
        if (isNumber(value)) {

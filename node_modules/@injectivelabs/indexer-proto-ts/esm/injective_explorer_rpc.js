...
export const TxData = {
    ...
    fromPartial(object) {
        ...
        message.signatures = ((_o = object.signatures) === null || _o === void 0 ? void 0 : _o.map((e) => Signature.fromPartial(e))) || [];
        return message;
    },
};
...
export const GetStatsRequest = {
    ...
    create(base) {
        return GetStatsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseGetStatsRequest();
        return message;
...
export const GetStatsResponse = {
    ...
    create(base) {
        return GetStatsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        const message = createBaseGetStatsResponse();

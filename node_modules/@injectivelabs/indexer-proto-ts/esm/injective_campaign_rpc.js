...
export const RankingRequest = {
    ...
    create(base) {
        return RankingRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const RankingResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            users: Array.isArray(object === null || object === void 0 ? void 0 : object.users) ? object.users.map((e) => CampaignUser.fromJSON(e)) : [],
    ...
    create(base) {
        return RankingResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseRankingResponse();
        message.campaign = (object.campaign !== undefined && object.campaign !== null)
            ...
            : undefined;
        message.users = ((_a = object.users) === null || _a === void 0 ? void 0 : _a.map((e) => CampaignUser.fromPartial(e))) || [];
...
export const Campaign = {
    ...
    create(base) {
        return Campaign.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.rewards = ((_k = object.rewards) === null || _k === void 0 ? void 0 : _k.map((e) => Coin.fromPartial(e))) || [];
...
export const CampaignUser = {
    ...
    create(base) {
        return CampaignUser.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const CampaignsRequest = {
    ...
    create(base) {
        return CampaignsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseCampaignsRequest();
...
export const CampaignsResponse = {
    ...
    fromJSON(object) {
        return {
            campaigns: Array.isArray(object === null || object === void 0 ? void 0 : object.campaigns) ? object.campaigns.map((e) => Campaign.fromJSON(e)) : [],
    ...
    create(base) {
        return CampaignsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseCampaignsResponse();
        message.campaigns = ((_a = object.campaigns) === null || _a === void 0 ? void 0 : _a.map((e) => Campaign.fromPartial(e))) || [];
        message.accumulatedRewards = ((_b = object.accumulatedRewards) === null || _b === void 0 ? void 0 : _b.map((e) => Coin.fromPartial(e))) || [];
...
export const CampaignsV2Request = {
    ...
    create(base) {
        return CampaignsV2Request.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const CampaignsV2Response = {
    ...
    fromJSON(object) {
        return {
            campaigns: Array.isArray(object === null || object === void 0 ? void 0 : object.campaigns) ? object.campaigns.map((e) => CampaignV2.fromJSON(e)) : [],
            cursor: isSet(object.cursor) ? String(object.cursor) : "",
        };
    },
    toJSON(message) {
    ...
    create(base) {
        return CampaignsV2Response.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseCampaignsV2Response();
        message.campaigns = ((_a = object.campaigns) === null || _a === void 0 ? void 0 : _a.map((e) => CampaignV2.fromPartial(e))) || [];
...
export const CampaignV2 = {
    ...
    create(base) {
        return CampaignV2.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.rewards = ((_l = object.rewards) === null || _l === void 0 ? void 0 : _l.map((e) => Coin.fromPartial(e))) || [];
...
export const ListGuildsRequest = {
    ...
    create(base) {
        return ListGuildsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseListGuildsRequest();
...
export const ListGuildsResponse = {
    ...
    fromJSON(object) {
        return {
            guilds: Array.isArray(object === null || object === void 0 ? void 0 : object.guilds) ? object.guilds.map((e) => Guild.fromJSON(e)) : [],
            paging: isSet(object.paging) ? Paging.fromJSON(object.paging) : undefined,
            updatedAt: isSet(object.updatedAt) ? String(object.updatedAt) : "0",
    ...
    create(base) {
        return ListGuildsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseListGuildsResponse();
        message.guilds = ((_a = object.guilds) === null || _a === void 0 ? void 0 : _a.map((e) => Guild.fromPartial(e))) || [];
        message.paging = (object.paging !== undefined && object.paging !== null)
            ? Paging.fromPartial(object.paging)
            : undefined;
...
export const Guild = {
    ...
    create(base) {
        return Guild.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const CampaignSummary = {
    ...
    create(base) {
        return CampaignSummary.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        const message = createBaseCampaignSummary();
...
export const ListGuildMembersRequest = {
    ...
    create(base) {
        return ListGuildMembersRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f;
        const message = createBaseListGuildMembersRequest();
...
export const ListGuildMembersResponse = {
    ...
    fromJSON(object) {
        return {
            members: Array.isArray(object === null || object === void 0 ? void 0 : object.members) ? object.members.map((e) => GuildMember.fromJSON(e)) : [],
            paging: isSet(object.paging) ? Paging.fromJSON(object.paging) : undefined,
    ...
    create(base) {
        return ListGuildMembersResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseListGuildMembersResponse();
        message.members = ((_a = object.members) === null || _a === void 0 ? void 0 : _a.map((e) => GuildMember.fromPartial(e))) || [];
        message.paging = (object.paging !== undefined && object.paging !== null)
            ? Paging.fromPartial(object.paging)
            : undefined;
...
export const GuildMember = {
    ...
    fromJSON(object) {
        return {
            ...
            tvlReward: Array.isArray(object === null || object === void 0 ? void 0 : object.tvlReward) ? object.tvlReward.map((e) => Coin.fromJSON(e)) : [],
            volumeReward: Array.isArray(object === null || object === void 0 ? void 0 : object.volumeReward) ? object.volumeReward.map((e) => Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return GuildMember.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.tvlReward = ((_k = object.tvlReward) === null || _k === void 0 ? void 0 : _k.map((e) => Coin.fromPartial(e))) || [];
        message.volumeReward = ((_l = object.volumeReward) === null || _l === void 0 ? void 0 : _l.map((e) => Coin.fromPartial(e))) || [];
        return message;
    },
};
...
export const GetGuildMemberRequest = {
    ...
    create(base) {
        return GetGuildMemberRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetGuildMemberRequest();
...
export const GetGuildMemberResponse = {
    ...
    create(base) {
        return GetGuildMemberResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseGetGuildMemberResponse();

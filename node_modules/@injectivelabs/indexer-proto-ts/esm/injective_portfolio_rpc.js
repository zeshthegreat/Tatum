...
export const TokenHoldersRequest = {
    ...
    create(base) {
        return TokenHoldersRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseTokenHoldersRequest();
...
export const TokenHoldersResponse = {
    ...
    create(base) {
        return TokenHoldersResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseTokenHoldersResponse();
...
export const AccountPortfolioBalancesRequest = {
    ...
    create(base) {
        return AccountPortfolioBalancesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseAccountPortfolioBalancesRequest();
...
export const AccountPortfolioBalancesResponse = {
    ...
    create(base) {
        return AccountPortfolioBalancesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseAccountPortfolioBalancesResponse();
        message.portfolio = (object.portfolio !== undefined && object.portfolio !== null)
...
export const PortfolioBalances = {
    ...
    create(base) {
        return PortfolioBalances.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBasePortfolioBalances();

...
export const GetABCIBlockEventsRequest = {
    ...
    create(base) {
        return GetABCIBlockEventsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetABCIBlockEventsRequest();
...
export const GetABCIBlockEventsResponse = {
    ...
    create(base) {
        return GetABCIBlockEventsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGetABCIBlockEventsResponse();
...
export const RawBlock = {
    ...
    create(base) {
        return RawBlock.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.txsResults = ((_d = object.txsResults) === null || _d === void 0 ? void 0 : _d.map((e) => ABCIResponseDeliverTx.fromPartial(e))) || [];
        message.beginBlockEvents = ((_e = object.beginBlockEvents) === null || _e === void 0 ? void 0 : _e.map((e) => ABCIEvent.fromPartial(e))) || [];
        message.endBlockEvents = ((_f = object.endBlockEvents) === null || _f === void 0 ? void 0 : _f.map((e) => ABCIEvent.fromPartial(e))) || [];
        return message;
    },
};
...
export const ABCIResponseDeliverTx = {
    ...
    fromJSON(object) {
        return {
            ...
            events: Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map((e) => ABCIEvent.fromJSON(e)) : [],
    ...
    create(base) {
        return ABCIResponseDeliverTx.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.events = ((_f = object.events) === null || _f === void 0 ? void 0 : _f.map((e) => ABCIEvent.fromPartial(e))) || [];
...
export const ABCIEvent = {
    ...
    fromJSON(object) {
        return {
            ...
            attributes: Array.isArray(object === null || object === void 0 ? void 0 : object.attributes) ? object.attributes.map((e) => ABCIAttribute.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return ABCIEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseABCIEvent();
        message.type = (_a = object.type) !== null && _a !== void 0 ? _a : "";
        message.attributes = ((_b = object.attributes) === null || _b === void 0 ? void 0 : _b.map((e) => ABCIAttribute.fromPartial(e))) || [];
        return message;
    },
};
...
export const ABCIAttribute = {
    ...
    create(base) {
        return ABCIAttribute.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseABCIAttribute();

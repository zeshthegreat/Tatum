...
export declare const EventBurnDenom: {
    encode(message: EventBurnDenom, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EventBurnDenom;
    fromJSON(object: any): EventBurnDenom;
    toJSON(message: EventBurnDenom): unknown;
    create(base?: DeepPartial<EventBurnDenom>): EventBurnDenom;

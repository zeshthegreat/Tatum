...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            ...
            storkPriceStates: Array.isArray(object === null || object === void 0 ? void 0 : object.storkPriceStates)
                ? object.storkPriceStates.map((e) => oracle_1.StorkPriceState.fromJSON(e))
                : [],
            storkPublishers: Array.isArray(object === null || object === void 0 ? void 0 : object.storkPublishers) ? object.storkPublishers.map((e) => String(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.storkPriceStates) {
            obj.storkPriceStates = message.storkPriceStates.map((e) => e ? oracle_1.StorkPriceState.toJSON(e) : undefined);
        }
        else {
    ...
    fromPartial(object) {
        ...
        message.storkPriceStates = ((_p = object.storkPriceStates) === null || _p === void 0 ? void 0 : _p.map((e) => oracle_1.StorkPriceState.fromPartial(e))) || [];
        message.storkPublishers = ((_q = object.storkPublishers) === null || _q === void 0 ? void 0 : _q.map((e) => e)) || [];
        return message;
    },
};

...
exports.Message = exports.HasProposalBlockPart = exports.VoteSetBits = exports.VoteSetMaj23 = exports.HasVote = exports.Vote = exports.BlockPart = exports.ProposalPOL = exports.Proposal = exports.NewValidBlock = exports.NewRoundStep = exports.protobufPackage = void 0;
/* eslint-disable */
const long_1 = __importDefault(require("long"));
const minimal_1 = __importDefault(require("protobufjs/minimal"));
const types_1 = require("../../libs/bits/v1/types");
const types_2 = require("../../types/v1/types");
exports.protobufPackage = "cometbft.consensus.v1";
...
function createBaseHasProposalBlockPart() {
    return { height: "0", round: 0, index: 0 };
}
exports.HasProposalBlockPart = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.height !== "0") {
            writer.uint32(8).int64(message.height);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseHasProposalBlockPart();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.HasProposalBlockPart.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseHasProposalBlockPart();
...
function createBaseMessage() {
    return {
        ...
        hasProposalBlockPart: undefined,
    };
}
exports.Message = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.hasProposalBlockPart !== undefined) {
            exports.HasProposalBlockPart.encode(message.hasProposalBlockPart, writer.uint32(82).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    message.hasProposalBlockPart = exports.HasProposalBlockPart.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            hasProposalBlockPart: isSet(object.hasProposalBlockPart)
                ? exports.HasProposalBlockPart.fromJSON(object.hasProposalBlockPart)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.hasProposalBlockPart !== undefined && (obj.hasProposalBlockPart = message.hasProposalBlockPart
            ? exports.HasProposalBlockPart.toJSON(message.hasProposalBlockPart)
            : undefined);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.voteSetBits = (object.voteSetBits !== undefined && object.voteSetBits !== null)
            ...
            : undefined;
        message.hasProposalBlockPart = (object.hasProposalBlockPart !== undefined && object.hasProposalBlockPart !== null)
            ? exports.HasProposalBlockPart.fromPartial(object.hasProposalBlockPart)
            : undefined;
        return message;
    },
};

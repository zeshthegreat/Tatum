...
export const ExtendedCommit = {
    ...
    create(base) {
        return ExtendedCommit.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseExtendedCommit();
        ...
        message.blockId = (object.blockId !== undefined && object.blockId !== null)
            ? BlockID.fromPartial(object.blockId)
            : undefined;
        message.extendedSignatures = ((_c = object.extendedSignatures) === null || _c === void 0 ? void 0 : _c.map((e) => ExtendedCommitSig.fromPartial(e))) || [];
        return message;
    },
};
...
export const ExtendedCommitSig = {
    ...
    create(base) {
        return ExtendedCommitSig.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {

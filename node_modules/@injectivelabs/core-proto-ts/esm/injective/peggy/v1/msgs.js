...
export const MsgBlacklistEthereumAddresses = {
    ...
    create(base) {
        return MsgBlacklistEthereumAddresses.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMsgBlacklistEthereumAddresses();
        message.signer = (_a = object.signer) !== null && _a !== void 0 ? _a : "";
        message.blacklistAddresses = ((_b = object.blacklistAddresses) === null || _b === void 0 ? void 0 : _b.map((e) => e)) || [];
        return message;
    },
};
...
export const MsgBlacklistEthereumAddressesResponse = {
    ...
    create(base) {
        return MsgBlacklistEthereumAddressesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseMsgBlacklistEthereumAddressesResponse();
        return message;
...
export const MsgRevokeEthereumBlacklist = {
    ...
    create(base) {
        return MsgRevokeEthereumBlacklist.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMsgRevokeEthereumBlacklist();
...
export const MsgRevokeEthereumBlacklistResponse = {
    ...
    create(base) {
        return MsgRevokeEthereumBlacklistResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseMsgRevokeEthereumBlacklistResponse();
        return message;

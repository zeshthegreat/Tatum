...
import { BlockID, Part, PartSetHeader, Proposal as Proposal1, signedMsgTypeFromJSON, signedMsgTypeToJSON, Vote as Vote2, } from "../../types/v1/types";
export const protobufPackage = "cometbft.consensus.v1";
...
export const HasProposalBlockPart = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.height !== "0") {
            writer.uint32(8).int64(message.height);
        }
    ...
    create(base) {
        return HasProposalBlockPart.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseHasProposalBlockPart();
...
export const Message = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.hasProposalBlockPart !== undefined) {
            HasProposalBlockPart.encode(message.hasProposalBlockPart, writer.uint32(82).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    message.hasProposalBlockPart = HasProposalBlockPart.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            hasProposalBlockPart: isSet(object.hasProposalBlockPart)
                ? HasProposalBlockPart.fromJSON(object.hasProposalBlockPart)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.hasProposalBlockPart !== undefined && (obj.hasProposalBlockPart = message.hasProposalBlockPart
            ? HasProposalBlockPart.toJSON(message.hasProposalBlockPart)
            : undefined);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.hasProposalBlockPart = (object.hasProposalBlockPart !== undefined && object.hasProposalBlockPart !== null)
            ? HasProposalBlockPart.fromPartial(object.hasProposalBlockPart)
            : undefined;
        return message;
    },
};

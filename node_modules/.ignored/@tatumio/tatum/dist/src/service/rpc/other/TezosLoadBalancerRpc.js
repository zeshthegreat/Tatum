...
exports.TezosLoadBalancerRpc = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const typedi_1 = require("typedi");
const util_1 = require("../../../util");
// Need to import like this to keep browser working
const LoadBalancer_1 = require("../generic/LoadBalancer");
const AbstractTezosRpc_1 = require("./AbstractTezosRpc");
let TezosLoadBalancerRpc = class TezosLoadBalancerRpc extends AbstractTezosRpc_1.AbstractTezosRpc {
    constructor(id) {
        super();
...
exports.TezosLoadBalancerRpc = TezosLoadBalancerRpc;
exports.TezosLoadBalancerRpc = TezosLoadBalancerRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
], TezosLoadBalancerRpc);
//# sourceMappingURL=TezosLoadBalancerRpc.js.map
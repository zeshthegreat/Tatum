...
exports.CasperLoadBalancerRpc = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const typedi_1 = require("typedi");
const util_1 = require("../../../util");
const AbstractCasperRpc_1 = require("./AbstractCasperRpc");
const LoadBalancer_1 = require("../generic/LoadBalancer");
let CasperLoadBalancerRpc = class CasperLoadBalancerRpc extends AbstractCasperRpc_1.AbstractCasperRpc {
    constructor(id) {
        super();
...
exports.CasperLoadBalancerRpc = CasperLoadBalancerRpc;
exports.CasperLoadBalancerRpc = CasperLoadBalancerRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
], CasperLoadBalancerRpc);
//# sourceMappingURL=CasperLoadBalancerRpc.js.map
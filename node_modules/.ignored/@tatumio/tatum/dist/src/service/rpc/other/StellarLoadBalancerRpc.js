...
exports.StellarLoadBalancerRpc = void 0;
...
let StellarLoadBalancerRpc = class StellarLoadBalancerRpc extends AbstractStellarRpc_1.AbstractStellarRpc {
    constructor(id) {
        super();
...
exports.StellarLoadBalancerRpc = StellarLoadBalancerRpc;
exports.StellarLoadBalancerRpc = StellarLoadBalancerRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
], StellarLoadBalancerRpc);
//# sourceMappingURL=StellarLoadBalancerRpc.js.map
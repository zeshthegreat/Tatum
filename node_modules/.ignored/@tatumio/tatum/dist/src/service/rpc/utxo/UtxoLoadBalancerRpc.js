...
let UtxoLoadBalancerRpc = class UtxoLoadBalancerRpc extends AbstractUtxoRpc_1.AbstractUtxoRpc {
    constructor(id) {
        super();
...
exports.UtxoLoadBalancerRpc = UtxoLoadBalancerRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
//# sourceMappingURL=UtxoLoadBalancerRpc.js.map
...
export interface RostrumRpcInterface {
     ...
     */
    blockchainAddressGetBalance: (params: AddressAndFilterParam) => Promise<JsonRpcResponse<BlockchainGetBalanceResult>>;
    /**
     ...
     */
    blockchainAddressGetFirstUse: (params: AddressAndFilterParam) => Promise<JsonRpcResponse<BlockchainGetFirstUseResult>>;
    /**
     ...
     */
    blockchainAddressGetHistory: (params: AddressAndFilterParam) => Promise<JsonRpcResponse<BlockchainHistoryResult[]>>;
    /**
     ...
     */
    blockchainAddressGetMempool: (params: AddressAndFilterParam) => Promise<JsonRpcResponse<BlockchainMempoolResult[]>>;
    /**
     ...
     */
    blockchainListUnspent: (params: AddressAndFilterParam) => Promise<JsonRpcResponse<BlockchainUnspentOutputResult[]>>;
    /**
     ...
     */
    blockchainScriptHashGetBalance: (params: ScriptHashAndFilterParam) => Promise<JsonRpcResponse<BlockchainGetBalanceResult>>;
    /**
     ...
     * @returns A promise resolving to the first usage details, including block hash, block height, and transaction hash.
     */
    blockchainScriptHashGetFirstUse: (params: ScriptHashAndFilterParam) => Promise<JsonRpcResponse<BlockchainGetFirstUseResult>>;
    /**
     ...
     * @returns A promise resolving to a list of transactions, each with details such as height, transaction hash, and optionally fee for mempool transactions.
     */
    blockchainScriptHashGetHistory: (params: ScriptHashAndFilterParam) => Promise<JsonRpcResponse<BlockchainHistoryResult[]>>;
    /**
     ...
     * @returns A promise resolving to a list of mempool transactions, each with details such as transaction hash, height, and fee.
     */
    blockchainScriptHashGetMempool: (params: ScriptHashAndFilterParam) => Promise<JsonRpcResponse<BlockchainMempoolResult[]>>;
    /**
     ...
     * @returns A promise resolving to a JSON RPC response wrapping a list of UTXOs.
     */
    blockchainScriptHashListUnspent: (params: ScriptHashAndFilterParam) => Promise<JsonRpcResponse<BlockchainUnspentOutputResult[]>>;
    /**
     ...
     */
    blockchainTransactionGet: (params: TransactionGetParams) => Promise<JsonRpcResponse<TransactionGetResult | VerboseTransactionResult>>;
    /**
     ...
     */
    blockchainTransactionGetMerkle: (params: TransactionGetMerkleParams) => Promise<JsonRpcResponse<TransactionGetMerkleResult>>;
    /**
     ...
     */
    blockchainTransactionIdFromPos: (params: TransactionIdFromPosParams) => Promise<JsonRpcResponse<TransactionIdFromPosResult>>;
    /**
     ...
     * @returns A promise that resolves to the balance of the script hash, separated into confirmed and unconfirmed amounts.
     */
    tokenScripthashGetBalance: (params: TokenScripthashGetBalanceParams) => Promise<JsonRpcResponse<TokenGetBalanceResult>>;
    /**
     * Fetches the confirmed and unconfirmed transaction history of a Bitcoin Cash script hash.
     ...
     */
    tokenScripthashGetHistory: (params: TokenScripthashGetHistoryParams) => Promise<JsonRpcResponse<TokenGetHistoryResult>>;
    /**
     * Fetches the unconfirmed transactions of a Bitcoin Cash script hash from the mempool.
     ...
     * @returns A promise resolving to a list of mempool transactions, each with details such as transaction hash, height, and fee.
     */
    tokenScripthashGetMempool: (params: TokenScripthashGetMempoolParams) => Promise<JsonRpcResponse<TokenGetMempoolResult>>;
    /**
     * Fetches an ordered list of unspent transaction outputs (UTXOs) sent to a Bitcoin Cash script hash.
     * The query can optionally be filtered to include all UTXOs, only token UTXOs, or exclude token UTXOs.
     *
     ...
     * @returns A promise resolving to a JSON RPC response wrapping a list of UTXOs.
     */
    tokenScripthashListUnspent: (params: TokenScripthashListUnspentParams) => Promise<JsonRpcResponse<TokenListUnspentResult>>;
    /**
     ...
     * @returns A promise resolving to a list of transactions, each with details such as height and transaction hash.
     */
    tokenTransactionGetHistory: (params: TokenTransactionGetHistoryParams) => Promise<JsonRpcResponse<TokenTransactionGetHistoryResult>>;
    /**
     ...
     * @returns A promise that resolves to the balance of the address, separated into confirmed and unconfirmed amounts.
     */
    tokenAddressGetBalance: (params: TokenAddressGetBalanceParams) => Promise<JsonRpcResponse<TokenGetBalanceResult>>;
    /**
     ...
     * @returns A promise resolving to a list of transactions, each with details such as height and transaction hash.
     */
    tokenAddressGetHistory: (params: TokenAddressGetHistoryParams) => Promise<JsonRpcResponse<TokenGetHistoryResult>>;
    /**
     ...
     * @returns A promise resolving to a list of mempool transactions, each with details such as transaction hash, height, and fee.
     */
    tokenAddressGetMempool: (params: TokenAddressGetHistoryParams) => Promise<JsonRpcResponse<TokenGetMempoolResult>>;
    /**
     ...
     * @returns A promise resolving to a JSON RPC response wrapping a list of UTXOs.
     */
    tokenAddressListUnspent: (params: TokenAddressGetHistoryParams) => Promise<JsonRpcResponse<TokenListUnspentResult>>;
    /**
    ...
    cashAccountQueryName: (params: CashAccountQueryNameParams) => Promise<JsonRpcResponse<CashAccountQueryResult>>;
